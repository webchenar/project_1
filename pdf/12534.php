...
$pdf->SetAuthor('سربرگ');
$pdf->SetTitle('سلام دنیا');
$pdf->SetSubject('آموزش php');
...
$html = '<h1>فارسی میشی</h1>
Some special characters: &lt; € &euro; &#8364; &amp; è &egrave; &copy; &gt; \\slash \\\\double-slash \\\\\\triple-slash
<h2>List</h2>
List example:
<ol>
    <li><img src="section2test/.png" alt="test alt attribute" width="30" height="30" border="0" /> test image</li>
    <li><b>متن بلد</b></li>
    <li><i>متن کج</i></li>
    <li><u>خط زیر متن</u></li>
    <li><b>b<i>bi<u>biu</u>bi</i>b</b></li>
    <li><a href="http://www.google.com" dir="ltr">گوگل</a></li>
...
<div style="text-align:center">وسط چین<br />
...
$pdf->writeHTML($html, true, false, true, false, 'right');
...
<table border="1" cellspacing="3" cellpadding="4">
    ...
    <tr>
        ...
        <td bgcolor="#FFFF00" align="right"><font color="#FF0000">قرمز</font> Yellow BG</td>
        <td>4C</td>
    </tr>
    <tr>
        <td>1A</td>
