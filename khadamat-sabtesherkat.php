...
<div class="container mb-5">
  <div class="row">
  <div class="d-flex justify-content-center align-items-center title-moshavereh">
                <span class="text-center text-white p-3 mt-5">خدمات ثبت شرکت</span>
            </div>
    ...
    <div class="col-md-6 col-lg-4 column">
      <div class="card card-khadamat gr-7">
        <div class="txt">
          <h1>ثبت شرکت نسبی </h1>
    ...
    <div class="col-md-6 col-lg-4 column">
      <div class="card card-khadamat gr-8">
        <div class="txt">
