    ...
    (i.prototype = {
          ...
          (i = a.resumableManager =
            {
              ...
              sendAjax: function (e, s, l) {
                var d,
                  ...
                  h = function (e, t) {
                    t && (e = e.setTokens(t)),
                      (e = m.resumableRequestError.setTokens({ msg: e })),
                      a._log(e),
                      l.reject(e);
                  };
                if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                  if (s > r.maxRetries)
                    return (
                      h(m.resumableMaxRetriesReached, { n: r.maxRetries }),
                    ...
                    (C = function (t, r, n) {
                      return a._isAborted()
                        ...
                        : ((w = a._getOutData(v, t)),
                          ...
                          i.pushAjax(e, s + 1),
                          void h(m.resumableRetryError, { n: s - 1 }));
                    }),
                    (x = function () {
                      a._isAborted() ||
      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          W._isPdfRendered() &&
            (M = W.pdfRendererTemplate.replace(
              "{renderer}",
              W._encodeURI(W.pdfRendererUrl)
            )),
          (W.defaults = {
            layoutTemplates: {
              main1: i,
          ...
          e.each(W.defaults, function (t, i) {
            return "allowedPreviewTypes" === t
              ? void (
                  void 0 === W.allowedPreviewTypes &&
                  (W.allowedPreviewTypes = i)
                )
              : void (W[t] = e.extend(!0, {}, i, W[t]));
          }),
          ...
          get: function (e, a) {
            ...
            return m && m.length
              ? ((a = void 0 === a ? !0 : a),
                ...
                (r = g
                  ? v(o, m, l, d, s, u, c)
                  : v("generic", m, l, d, s, u, c, o).setTokens({
                      content: p.content[e],
                    })),
      ...
      _setZoomContent: function (i, a) {
        ...
        y &&
          ...
          (o = r.length ? '<span class="kv-spacer"></span>\n' + r.html() : ""),
      ...
      _zoomSlideShow: function (t, i) {
        var a,
          ...
          u = d.length;
        if (
          (s.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"),
          !l.attr("disabled"))
        ) {
          for (r = 0; u > r; r++)
            (n = e(d[r])),
          ...
          0 > o ||
            ...
            !c[o] ||
            ((a = e(c[o])),
            a.length && s._setZoomContent(a, t),
            s._initZoomButtons(),
      ...
      _initUploadSuccess: function (i, a, r) {
        ...
        return !m.showPreview || "object" != typeof i || e.isEmptyObject(i)
          ...
          : (void 0 !== i.initialPreview &&
              ...
              d.length > 0 &&
                !t.isArray(d) &&
                (d = d.split(m.initialPreviewDelimiter)),
              d.length &&
                (m._mergeArray("initialPreview", d),
                m._mergeArray("initialPreviewConfig", c),
                m._mergeArray("initialPreviewThumbTags", u)),
              void 0 !== a
                ? r
                  ? ((p = a.attr("id")),
                    (f = m._getUploadCacheIndex(p)),
                    null !== f &&
                      (m.uploadCache[f] = {
                        id: p,
                        content: d[0],
                ...
                setTimeout(function () {
                  t.isEmpty(s) || t.isEmpty(s.error)
                    ...
                    : ((c = !0),
                      ...
                      w._setProgress(
                        101,
                        w._getFrame(m).find(".file-thumb-progress"),
                        w.msgUploadError
                      ));
                }, w.processDelay);
            }),
              ...
              (o = l._parseError(m, t, a)),
                ...
                l.showPreview &&
                  ...
                  l._setProgress(
                    101,
                    l.$progress,
                    l.msgAjaxProgressError.replace("{operation}", m)
                  ));
            });
          var g = 0;
          e.each(l.fileManager.stack, function (e, i) {
            t.isEmpty(i.file) ||
              l._setFileData(f, i.file, i.nameFmt || "untitled_" + g, e),
              g++;
          }),
      ...
      _getSize: function (t, i) {
        ...
        return e.isNumeric(t) && e.isNumeric(o)
          ? ("function" == typeof s
              ...
              ? (r = "0.00 B")
              : (i || (i = n.sizeUnits),
                (a = Math.floor(Math.log(o) / Math.log(n.bytesToKB))),
                (r = (o / Math.pow(n.bytesToKB, a)).toFixed(2) + " " + i[a])),
        ...
        return (
          ...
          (w = function (a, l, d, u, g) {
            ...
            return (
              ...
              t.isEmpty(m) ||
                (void 0 !== m.title && null !== m.title && (T = m.title),
                void 0 !== m.alt && null !== m.alt && (T = m.alt)),
              (h = {
                previewId: v,
                caption: _,
                title: T,
          ...
          b.fileActionSettings.showZoom &&
            (C = w(E ? "other" : i, a, !0, "kv-zoom-thumb", g)),
          (C =
            "\n" +
      ...
      _previewFile: function (e, i, a, r, n) {
        if (this.showPreview) {
          var o,
            ...
            h = g.getId(i),
            v = s._getThumbId(h);
          (o = s._generatePreviewTemplate(u, m, l, d, v, h, !1, f)),
            s._clearDefaultPreview(),
            s._addToPreview(p, o);
          var w = s._getFrame(v);
          s._validateImageOrientation(w.find("img"), i, v, h, c, d, f, m),
            s._setThumbAttr(v, c, f),
            s._initSortable();
        }
      },
      ...
      _checkDimensions: function (e, i, a, r, n, o, s) {
        ...
        !t.isEmpty(m) &&
          ...
          (u = "Small" === i ? d >= m : m >= d),
          u ||
            ((l = p["msgImage" + o + i].setTokens({ name: n, size: m })),
        ...
        (c && u) ||
          ...
          i.off(l).on(l, function () {
            ...
            var g = Math.atan(u / c),
              ...
              w = " scale(" + Math.abs(v) + ")";
            t.setTransform(e, m + w),
              t.setTransform(l, m + w),
              f &&
                (i
      ...
      _validateImageOrientation: function (i, a, r, n, o, s, l, d) {
        ...
        return (
          (f = p._getExifObj(d)),
          p.canOrientImage
            ? (i.css("image-orientation", m ? "from-image" : "none"),
          ...
          m
            .one("load", function () {
              (l = p.width()),
                ...
                c.resizeImage ||
                  (c._checkDimensions(f, "Large", m, p, i, "Width", s),
                  c._checkDimensions(f, "Large", m, p, i, "Height", s)),
      ...
      _getResizedImage: function (i, a, r, n) {
        ...
        if (
          ((c = function (e, t, i) {
            h.isAjaxUpload ? h._showFileError(e, t, i) : h._showError(e, t, i),
              h._setPreviewError(E);
          }),
          (f = h.fileManager.getFile(i)),
          (m = { id: F, index: S, fileId: i }),
          (g = [i, F, S]),
          (!f || !y || (C >= w && x >= b)) &&
            (y && f && h._raise("fileimageresized", g),
            r.val++,
        ...
        try {
          P.drawImage(v, 0, 0, w, b),
            ...
            o instanceof Blob ||
              c(h.msgImageResizeError, m, "fileimageresizeerror");
        } catch (A) {
          r.val++,
            r.val === n && h._raise("fileimagesresized", [void 0, void 0]),
      ...
      _change: function (i) {
        ...
        if (
          ...
          if (
            ...
            if (!a.autoReplace || s > m)
              return void b(a.autoReplace && s > m ? s : n, m);
            n > m && a._resetPreviewThumbs(c);
          } else {
            if (h && ((n = a._getFileCount(o, !0)), g > 0 && n > g)) {
              if (!a.autoReplace || s > m)
                return void b(a.autoReplace && s > g ? s : n, g, !0);
              n > m && a._resetPreviewThumbs(c);
            }
            !c || v
            ...
            var x,
              ...
              q = function () {
                ...
                setTimeout(function () {
                  ...
                  r._raise("fileloaded", [j, U, $, w, n]) && r.isAjaxUpload
                    ? e || C.add(j)
                    : e && C.removeFile($);
              };
            if (j) {
                ...
                return (
                  ...
                  void (r.isAjaxUpload
                    ? (r.duplicateErrors.push(T),
                      ...
                      r._raise("fileduplicateerror", [j, E, R, x, U, w]),
                      a(w + 1),
                      r._updateFileDetails(u))
                    : (r._showError(T, V),
                      r.unlock(),
              ...
              if (!r._canPreview(j))
                return (
                  (I = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n])),
                  r.isAjaxUpload && I && C.add(j),
                  r.showPreview &&
                    I &&
      ...
      upload: function () {
        ...
        if (
          ...
          if (((r.lastProgress = 0), r._resetUpload(), 0 === o && !s))
            return void r._showFileError(r.msgUploadEmpty);
          if (((r.cancelling = !1), r._showProgress(), r.lock(), 0 === o && s))
  ...
  (e.fn.fileinput.defaults = {
    ...
    (e.fn.fileinputLocales.en = {
      ...
      msgFoldersNotAllowed:
        "فایل ها را به این مکان بکشید {n} folder(s) dropped were skipped.",
      msgImageWidthSmall:
